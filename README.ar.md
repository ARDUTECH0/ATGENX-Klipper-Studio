...
- **خريطة التوصيلات:** البورده في النص وكل جهاز حواليها وكل خط مكتوب عليه الرجل بتاعته: المحركات ومخارج
  الدرايفرات، السخانات، الثرمستورات، المراوح، المسبار، الإضاءة، والأقسام اللي ضفتها، وأي بورده تانية (Pico أو
  بورده راس). الأحمر معناه رجل فاضية أو مستخدمة مرتين أو على بورده مقفولة. تضغط على الجهاز تعدّل أرجله، وتقدر
  تحفظ الرسم كله صورة PNG.
...
### ويندوز - من غير بايثون

نزّل **KlipperStudio.exe** من [آخر إصدار](../../releases/latest) ودوس عليه دبل كليك.
ويندوز هيطلّع تحذير إن الملف مش موقّع (التوقيع محتاج شهادة بفلوس): **More info -> Run anyway**.
...
[GNU GPL v3.0 أو أحدث](LICENSE):
- **برنامج حر**: استخدمه وادرسه وعدّله ووزّعه.
- لو وزّعته أو وزّعت برنامج مبني عليه، لازم تدي الناس نفس الحريات وتوفر الكود تحت نفس الترخيص.
- بيجي **بدون أي ضمان**.
